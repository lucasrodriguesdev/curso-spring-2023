...
public class PacienteController {
    ...
    @PostMapping
    @Transactional
    public ResponseEntity cadastroPaciente(@RequestBody @Valid DadosPaciente dadosPaciente, UriComponentsBuilder uriBuilder){
    ...
    @PutMapping
    @Transactional
    public ResponseEntity atualizar(@RequestBody @Valid DadosAtualizaveisPaciente dados){
